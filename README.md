...
You should have files similar to this: / ├── index.html (home / about page) ├── projects.html (project showcase page) ├── style.css (main stylesheet) ├── images/ (photos, icons, logos) └── README.md (this file)
...
Take your time. Be intentional. Make it yours.
